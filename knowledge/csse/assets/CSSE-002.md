# Asset Profile: CSSE-002

- **Asset ID:** CSSE-002
- **Title:** English Continuous Writing — Sample Mark Scheme
- **Provider:** CSSE (Consortium of Selective Schools in Essex)
- **Document Type:** Official Mark Scheme
- **Publication Year:** Undated on the document itself; hosted by CSSE since at least 2020 (source page last updated 07/04/2020)
- **Evidence Level:** A — Official examination authority mark scheme
- **Repository Location:** `knowledge/csse/mark-schemes/ECW-Sample-Mark-Scheme.pdf`
- **Original Source:** https://csse.org.uk/storage/2020/05/ECW-Sample-Mark-Scheme.pdf (linked from https://csse.org.uk/examination/)
