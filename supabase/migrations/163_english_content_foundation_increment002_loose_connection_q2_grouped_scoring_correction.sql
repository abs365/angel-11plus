...
insert into public.ali_question_bank
  (id, subject, skill, pathway, content_difficulty, question_type, estimated_time_seconds,
   ...
   transfer_class)
select * from (values
('eng-inc002-roboticsfinal-q02b', 'english', 'QT-RC-04', array['csse'], 'medium', 'short-answer', 60,
...
('eng-inc002-roboticsfinal-q02c', 'english', 'QT-RC-04', array['csse'], 'medium', 'short-answer', 60,
...
('eng-inc002-roboticsfinal-q02d', 'english', 'QT-RC-04', array['csse'], 'medium', 'short-answer', 60,
...
('eng-inc002-roboticsfinal-q02e', 'english', 'QT-RC-04', array['csse'], 'medium', 'short-answer', 60,
...
where not exists (
  select 1 from public.ali_question_bank where id = 'eng-inc002-roboticsfinal-q02b'
);
