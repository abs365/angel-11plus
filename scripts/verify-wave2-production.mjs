...
const live = JSON.parse(
  readFileSync(
    "C:/Users/Admin/AppData/Local/Temp/claude/C--Users-Admin/135f4c11-3911-48ce-b2ad-471be84f3f8b/scratchpad/wave2_live.json",
    "utf8"
  )
);
...
for (const item of generated) {
  ...
  const checks = [
    ...
    ["supporting_competencies", JSON.stringify(row.supporting_competencies), JSON.stringify(item.supportingCompetencies.length ? item.supportingCompetencies : null)],
  ];
