    ...
    <footer className="border-t border-[var(--border)] bg-[var(--surface)]">
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-10">
        <div className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm font-medium text-[var(--text-secondary)]">
          <Link href="/privacy" className="hover:text-[var(--text-primary)] transition-colors motion-reduce:transition-none">
            Privacy
          </Link>
          <Link href="/terms" className="hover:text-[var(--text-primary)] transition-colors motion-reduce:transition-none">
            Terms
          </Link>
          <Link href="/contact" className="hover:text-[var(--text-primary)] transition-colors motion-reduce:transition-none">
            Contact and support
          </Link>
          <Link href="/login?mode=signin" className="hover:text-[var(--text-primary)] transition-colors motion-reduce:transition-none">
            Sign in
          </Link>
        </div>

        <p className="mt-6 text-xs text-[var(--text-tertiary)] leading-relaxed max-w-2xl">
        ...
        <p className="mt-4 text-xs text-[var(--text-tertiary)]">© 2026 Angel Digital</p>
      </div>
    </footer>
  );
}
