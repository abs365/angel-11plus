...
| `topic` | **PROPOSED** | id, name, parent_competency_id | New in this work package (`CSSE_COMPETENCY_FRAMEWORK.md` §1) — the curriculum-content layer beneath competencies. Does not exist in any form today. |
